...
const portfinder = require('portfinder') // 获取可用的端口
...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    ...
    hot: true,
    contentBase: false, // 使用CopyWebpackPlugin，所以无需contentBase
    compress: true,
    host: HOST || config.dev.host,
    port: PORT || config.dev.port,
    useLocalIp: true, // 使用本机IP，进而可以在局域网内访问
  ...
  plugins: [
    new webpack.DefinePlugin({ // 定义开发环境变量
